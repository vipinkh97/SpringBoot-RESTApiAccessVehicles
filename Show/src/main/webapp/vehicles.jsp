...
<body>
  ...
  <tbody>
        ...
        <tr>
		  ...
		  <td><a href="/Show/vehicles/${vehicle.getId()}"><button type="button" class="btn btn-info">View Details</button></a></td>
        </tr>
        </c:forEach>
       </tbody>
</table>
    ...
    <div>
    <a href="/Show/addVehicle.jsp"><button type="button" class="btn btn-success">Add</button></a>
    </div>
		</div>
